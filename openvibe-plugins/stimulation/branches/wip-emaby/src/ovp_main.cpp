...
#include "box-algorithms/stimulation/adaptation/ovpCBoxAlgorithmStimulationReject.h"
...
OVP_Declare_Begin();
	...
	OVP_Declare_New(OpenViBEPlugins::Stimulation::CBoxAlgorithmStimulationRejectDesc);
