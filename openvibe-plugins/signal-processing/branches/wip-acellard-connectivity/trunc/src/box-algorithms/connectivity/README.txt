...
[Fri Apr 19 11:21:04 2013]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmConnectivityMeasure.h
- ovpCBoxAlgorithmConnectivityMeasure.cpp
...
You may have to change the file ovpCBoxAlgorithmConnectivityMeasure.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmConnectivityMeasure.h"
