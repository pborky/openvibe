...
#include "algorithms/basic/ovpCRMS.h"
...
#include "box-algorithms/basic/ovpCBoxAlgorithmSNR.h"
...
//	OVP_Declare_New(OpenViBEPlugins::SignalProcessing::CSpatialFilterBoxAlgorithmDesc)
	...
	OVP_Declare_New(OpenViBEPlugins::SignalProcessing::CRMSDesc)
	OVP_Declare_New(OpenViBEPlugins::SignalProcessing::CBoxAlgorithmSNRDesc)
