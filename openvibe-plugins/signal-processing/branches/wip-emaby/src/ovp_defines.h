...
#define OVP_ClassId_Algorithm_RMS 														OpenViBE::CIdentifier(0xAF5D4EE9, 0x267096F2)
#define OVP_ClassId_Algorithm_RMSDesc 													OpenViBE::CIdentifier(0x919ABE23, 0xA33BCEFF)

#define OVP_Algorithm_RMS_InputParameterId_MatrixSignal                                 OpenViBE::CIdentifier(0x68038BBE, 0x0E77E886)
#define OVP_Algorithm_RMS_OutputParameterId_MatrixRMS                                   OpenViBE::CIdentifier(0x3EEABB90, 0xC61B22F9)
#define OVP_Algorithm_RMS_InputTriggerId_Initialize                                     OpenViBE::CIdentifier(0x7121E17F, 0x085ECA11)
#define OVP_Algorithm_RMS_InputTriggerId_Apply                                          OpenViBE::CIdentifier(0xC11286A5, 0xE1E1C299)
